	...
	; 1: 7 REF_BLOCK :[i 0 while i < 1 :[nl i i + 1] print A . B] type: ()=>void
	JMP AFTER_0
CALL_0:
	...
	LDA STACKACCESS + 1
	STA $0101,X
	; 3: 5 WHILE while type: (boolean,void)=>void
startloop11:
	; 3: 13 LT < type: (number,number)=>boolean
	; 3: 11 WORD i type: ()=>number
	TSX
	TXA
	CLC
	ADC #1
